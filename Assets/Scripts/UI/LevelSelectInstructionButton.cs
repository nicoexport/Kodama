...
namespace UI {
    public class LevelSelectInstructionButton : MonoBehaviour {
        ...
        private void OnEnable() => LevelSelectManager.OnSelectUISwitched += ChangeButtonText;

        private void OnDisable() => LevelSelectManager.OnSelectUISwitched -= ChangeButtonText;
