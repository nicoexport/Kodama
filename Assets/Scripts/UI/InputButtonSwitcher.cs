...
namespace UI {
    public class InputButtonSwitcher : MonoBehaviour {
        ...
        private void Awake() => OnInputDeviceChange(InputManager.CurrentInputDevice);

        private void OnEnable() => InputManager.OnInputDeviceChanged += OnInputDeviceChange;

        private void OnDisable() => InputManager.OnInputDeviceChanged -= OnInputDeviceChange;
